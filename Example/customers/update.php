...
SET
customer_password = '{$in_customer_password}',
first_name = '{$in_first_name}',
last_name = '{$in_last_name}',
customer_image = '{$in_customer_image}',
phone = '{$in_phone}',
email = '{$in_email}',
status = '{$in_status}',
...
home_address_state = '{$in_home_address_state}',
home_address_city = '{$in_home_address_city}',
home_address_street = '{$in_home_address_street}',
home_address_alley = '{$in_home_address_alley}',
home_address_postal_code = '{$in_home_address_postal_code}'
WHERE 
