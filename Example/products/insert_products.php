...
$sql->bind_param('sssssssssis', $in_product_code, $in_product_name, $in_product_vendor, $json_product_attributes, $in_product_description, $in_product_image, $in_color, $in_discount, $in_buy_price, $in_quantity_in_stock, $in_product_line_id);
